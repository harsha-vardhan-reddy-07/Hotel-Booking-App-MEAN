...
import { SuperadminLoginComponent } from './admin/superadmin-login/superadmin-login.component';
import { EditBookingComponent } from './admin/edit-booking/edit-booking.component';
import { EditHotelSelfComponent } from './admin/edit-hotel-self/edit-hotel-self.component';
...
const routes: Routes = [
  ...
  {path: 's-admin-login', component:SuperadminLoginComponent},
  {path: 'edit-booking', component:EditBookingComponent},
  {path: 'edit-self-hotel', component: EditHotelSelfComponent}
